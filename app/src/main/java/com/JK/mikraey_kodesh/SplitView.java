...
public class SplitView extends LinearLayout implements OnTouchListener {
    ...
    private View mExitButton, mExitButtonBlack;
    ...
    public void onFinishInflate() {
        ...
        mExitButton = findViewById(R.id.exitNoteButton);
        mExitButtonBlack = findViewById(R.id.exitNoteButtonBlack);
        ...
        mExitButtonBlack.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
               onClickExitBtn(view);
            }
    ...
    public void onClickExitBtn(View view){
        ...
        LayoutParams params = (LayoutParams) mSecondaryContent.getLayoutParams();
        params.weight = 1;
        params.height = LayoutParams.MATCH_PARENT;
        mSecondaryContent.setLayoutParams(params);
        params = (LayoutParams) mPrimaryContent.getLayoutParams();
        params.weight = 1;
        params.height = LayoutParams.MATCH_PARENT;
        mPrimaryContent.setLayoutParams(params);
    }
